...
import com.glassait.androidproject.databinding.FragmentSeeAllMyOfferBinding;
 ...
 */
public class SeeAllMyOfferRecyclerViewAdapter
        extends RecyclerView.Adapter<SeeAllMyOfferRecyclerViewAdapter.ViewHolder> {
    // Database part
    ...
    public SeeAllMyOfferRecyclerViewAdapter(List<Offer> offerList) {
        mList = offerList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(FragmentSeeAllMyOfferBinding.inflate(
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mCityView.setText(user[0].city);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(FragmentSeeAllMyOfferBinding binding) {
